...
<html>
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	   ...
	   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			   ...
			   <input type="submit" value="Add Achievement" name="add" class="register-button" style="margin-left: 160px">
		</form>
...
$query = "insert into uachievment(achvid,achvname,achvdesc,achvfield) values ('$id','$dname1','$dname','$fname')";

if( !mysqli_query($conn,$query) )
{
  echo "<script>";
  echo "alert('Error during add achivement.')";
  echo "</script>";
}
else
{
	echo "<script>";
	echo "alert('Achievement inserted successfully.')";
	echo "</script>";
}
