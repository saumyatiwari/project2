		...
		<h2>
			...
			<div class="table-responsive">
				...
				<?php
					...
					$result = $database->prepare ("SELECT * FROM uachievment");
					$result ->execute();
					for ($count=0; $row_member = $result ->fetch(); $count++){
					$id = $row_member['achvid'];
				?>
					<tr>
						<td style="text-align:center;"><?php echo $row_member['achvname']; ?></td>
								<td style="text-align:center;"><?php echo $row_member['achvdesc']; ?></td>
								<td style="text-align:center;"><?php echo $row_member['achvfield']; ?></td>
					</tr>
					<?php	}	?>
				</table>
			</div>
