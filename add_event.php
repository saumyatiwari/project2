...
<html>
    ...
    <!-- _______________________Start of content Area_____________________________-->
      <div id="content" style=" height:480px">
	   ...
	   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   	   Event Name<sup>*</sup>
			   <input type="text" name="formdes1" class="register-input" required > <br>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;



			   Event Date<sup>*</sup>
			   <input type="date" name="formdes" class="register-input" required > <br>

	   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			   Event Time<sup>*</sup>
			   <input type="time" name="formfield" class="register-input" required > <br>
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			   Event Description<sup>*</sup>
			   <input type="text" name="formfield1" class="register-input" required > <br>





			   <input type="submit" value="Add Event" name="add" class="register-button" style="margin-left: 160px">
		</form>
...
$id = $_SESSION['id'];
$dname1 = $_POST['formdes1'];
$dname = $_POST['formdes'];
$fname = $_POST['formfield'];
$fname1 = $_POST['formfield1'];


$query = "insert into event1(eventid,ename,date,etime,des) values ('$id','$dname1','$dname','$fname','$fname1')";

if( !mysqli_query($conn,$query) )
{
  echo "<script>";
  echo "alert('Error during add event.')";
  echo "</script>";
}
else
{
