...
<h1 ><center>DELETE INTERVIEW EXPERIENCE</center></h1>
<form method="post">
<table class="register" border="1px"cellpadding="10px">
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			   ...
			   Interview Id<sup>*</sup>
			   <input type="text" name="eid" value="<?php echo $id ?>" class="register-input" required > <br>
...
<?php
	...
	if(isset($_POST['delete']))
	{
		...
		$query = "delete from intervi where inid = '$id'";
