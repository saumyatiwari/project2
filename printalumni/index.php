...
<html lang="en">
  <head>
    ...
    <title>show alumni details..</title>
...
Alumni details..
			...
			<div class="table-responsive">
				...
				<?php
					...
					$result = $database->prepare ("SELECT * FROM user where Year_of_joining < 2015");
					$result ->execute();
					for ($count=0; $row_member = $result ->fetch(); $count++){
					$id = $row_member['UserID'];
				?>
					<tr>
						<td style="text-align:center;"><?php echo $row_member['fname']; ?></td>
								<td style="text-align:center;"><?php echo $row_member['mailid']; ?></td>
								<td style="text-align:center;"><?php echo $row_member['contact']; ?></td>
					</tr>
					<?php	}	?>
				</table>
			</div>
