...
<h1 ><center>DELETE EVENT</center></h1>
<form method="post">
<table class="register" border="1px"cellpadding="10px"  method="post">
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			event id<sup>*</sup> : &nbsp;&nbsp;
			   <select name="event" style="width: 40%;" >
			   <option>Select an Option</option>
			   <?php get_event(); ?>
			   </select><br><br>

</table>
<center>  <button type="submit" name="submit" formaction  = "adminupdate_event1.php">Submit</button></center>
</form>
      </div>
