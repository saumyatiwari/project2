        ...
        <div id="page">
          <div id="header">
            <div id="section">
			  ...
			  <p style="font-size:15px; float:left;  font-weight:bold; margin-left:20px; margin-top:25px; color:white;"> Motilal Nehru National Institute Of Technology Allahabad <br> </p> 		
